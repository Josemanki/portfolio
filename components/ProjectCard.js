...
const ProjectCard = ({
  ...
  return (
    <div className="flex h-full flex-col justify-between max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-neutral-800 dark:border-gray-700">
      <a
        target="_blank"
        rel="noreferrer"
        href={projectUrl ? projectUrl : '#recent-work'}
      >
        <div className="w-100 h-[180px] h-100 relative">
          <Image
