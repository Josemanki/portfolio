      ...
      >
        ...
        <div className="h-screen flex flex-col items-center justify-center gap-14 text-4xl font-bold text-regular-800">
          ...
          <div className="mt-6 flex gap-4">
            <Link href={'https://www.linkedin.com/in/jose-ehg/'} target="_blank" rel="noreferrer">
              <a>
            ...
            <Link href={'https://github.com/Josemanki/'} target="_blank" rel="noreferrer">
              <a>
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <Link href={'mailto:hello@hernandez-jose.com?subject=Mail from your site'}>
              <a>
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path
