...
const MessageSection = () => {
  return (
    <section id="message" className="min-h-screen bg-custom-teal px-6 flex items-center">
      <div className="relative decoration-top decoration-bottom lg:px-42 xl:px-80 xl:decoration-top-alt xl:decoration-bottom-alt">
        <p className="text-white font-black text-3xl leading-relaxed sm:text-5xl sm:leading-normal lg:p-10">
          I am a developer compromised with{' '}
          <span className="text-neutral-800 font-normal">bringing maximum quality and value to amazing products.</span>{' '}
