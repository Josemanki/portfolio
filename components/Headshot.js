...
const Headshot = () => {
  return (
    <div className="p-6 flex flex-col items-center justify-center mt-12 bg-black/[.3] rounded">
      ...
      <div className="grid grid-cols-about-grid grid-rows-about-grid grid-rows-3 gap-2 mt-6">
        <div>
        ...
        <div>
          <p className="text-sm">Spanish (Native), English (Full professional proficiency)</p>
        </div>
        <div>
