...
const AboutMe = () => {
  return (
    <section id="about-me" className="section-home min-h-screen bg-neutral-800 text-white lg:h-screen">
      <div className="py-12 px-6 h-full flex flex-col items-center justify-around">
        ...
        <div className="md:flex md:items-center md:gap-10 lg:gap-20 lg:px-10 2xl:px-32 xl:gap-40 xl:text-xl">
          ...
          <div className="my-12 text-justify xl:pr-20">
            <p className="mt-6">
              Hey there! - My name is Jose and I am a Fullstack Web Developer recently graduated from SPICED Academy,
              originally from Venezuela and based in Berlin.
            </p>
            <p className="mt-6">
            ...
            <p className="mt-6">
              ...
              more technologies and polished my existing ones, and found myself in love with the idea of being a
              Fullstack developer.
            </p>
            <p className="mt-6">
